    ...
    const bentoCards = [
        {
            ...
            description: 'Access and view content shared by administrators, including the latest updates, resources, and information available to your role.',
            label: 'Info'
        },
        {
            color: '#120F17',
            title: 'Your Status',
            description: userQuery.data?.message || 'Loading...',
            label: 'Status'
        },
        {
            color: '#120F17',
            title: 'Authorities',
            description: userQuery.data?.authorities?.[0]?.authority || 'ROLE_USER',
            label: 'Role'
        }
    ];
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        <div className="flex items-center gap-3">
                            <div className="w-8 h-8 rounded-full bg-blue-600 flex items-center justify-center font-bold text-sm shadow-[0_0_10px_rgba(37,99,235,0.5)]">
                                {user?.name?.charAt(0).toUpperCase()}
                            </div>
                            <h1 className="text-lg font-bold tracking-wide font-serif">Member Hub</h1>
                        </div>
            ...
            <main className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                        ...
                        <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold min-h-[120px] max-w-3xl leading-tight">
                            <TextType 
                              text={[
                                  `Hello ${user?.name || ''}!`, 
                                  "You are a user.", 
                                  "As a user you can access stuff that admin uploads."
                              ]}
                              typingSpeed={50}
                              pauseDuration={1500}
                              showCursor={true}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
                    <div className="lg:col-span-1 flex justify-center lg:justify-start">
                        <ReflectiveCard user={user} color="#ffffff" overlayColor="rgba(59, 130, 246, 0.1)" />
                    </div>
