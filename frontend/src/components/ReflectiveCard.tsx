      ...
      <div className="reflective-content">
        ...
        <div className="card-body">
          <div className="user-info">
            <h2 className="user-name">{user?.name?.toUpperCase() || 'USER'}</h2>
            <p className="user-role">{user?.role?.toUpperCase() || 'MEMBER'}</p>
          </div>
        </div>

        <div className="card-footer">
          <div className="id-section" style={{maxWidth: '180px'}}>
            <span className="label">EMAIL</span>
            <span className="value" style={{fontSize: '11px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap'}}>{user?.email || 'N/A'}</span>
          </div>
